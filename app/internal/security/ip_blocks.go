...
// blockInfoInternal is used internally within CheckIPBlock to avoid importing models
// for the serveBlockedPage helper.
type blockInfoInternal = models.BlockInfo
